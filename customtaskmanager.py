...
class TaskManagerApp:
    def __init__(self, root):
        ...
        # Middle frame for process table
        ...
        # Ensure threads stop when window closes
    ...
    def refresh_processes(self):  # ← FIXED: Proper indentation here
        ...
        # First pass: warm up cpu_percent for each process
        procs = []
        ...
        # Small delay to measure CPU usage over an interval
        time.sleep(0.3)

        # Second pass: read actual CPU% and memory
        info_list = []
        for p in procs:
            try:
                with p.oneshot():
